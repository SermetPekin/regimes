...
class TestRegressionResultsBase:
    ...
    def test_df_model(
        self, ols_results: rg.OLSResults
    ) -> None:
    ...
    def test_conf_int_lower_less_than_upper(
        self, ols_results: rg.OLSResults
    ) -> None:
    ...
    def test_conf_int_different_alpha(
        self, ols_results: rg.OLSResults
    ) -> None:
    ...
    def test_to_dataframe_index(
        ...
        expected_names = ols_results.param_names or [f"x{i}" for i in range(len(ols_results.params))]
...
class TestADLResults:
    ...
    def test_ar_params(
        self, adl_results: rg.ADLResults
    ) -> None:
...
class TestBreakResultsBase:
    ...
    def test_n_breaks(
        self, bp_results: rg.BaiPerronResults
    ) -> None:
...
class TestRollingResultsBase:
    ...
    def test_is_rolling(
        self, rolling_results: rg.RollingOLSResults
    ) -> None:
...
class TestRecursiveResults:
    ...
    def test_is_not_rolling(
        self, recursive_results: rg.RecursiveOLSResults
    ) -> None:
        """Test is_rolling is False for recursive."""
        assert not recursive_results.is_rolling

    def test_window_is_none(
        self, recursive_results: rg.RecursiveOLSResults
    ) -> None:
